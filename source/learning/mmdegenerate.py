"""My attempt to show a simple failure case of SVM struct"""
...
def read_examples(filename, sparm):
    ...
    #                                      ntimesteps=10,
    #                                      nstates=20)
    return [([1,1],1), ([0,1],0), ([1,0],0), ([0,0],0)]
...
def print_iteration_stats(ceps, cached_constraint, sample, model,
    ...
    print 'Current transition model: ',list(model.w)
...
def print_learning_stats(sample, model, cset, alpha, sparm):
    ...
    print 'Model learned: ',list(model.w)
    print 'Losses:',
